...
def send_verify_mail(user):
    ...
    title = f'Confirm your email address'
    message = f'{user.username}, verify your e-mail to finish signing up for\
    {settings.DOMAIN_NAME} by clicking on the link below:\
